...
CHECKS=(
  ...
  "bash scripts/tests/test-auto-dispatch-requeue.sh"
  ...
  "bash scripts/tests/test-detect-dependency-cycles.sh"
  "bash scripts/tests/test-dedupe-create-pr-safe-outputs.sh"
  ...
  "bash scripts/tests/test-reconcile-parent-pipeline-issues.sh"
  "bash scripts/tests/test-remove-issue-dependency.sh"
  "bash scripts/tests/test-repo-assist.sh"
  "bash scripts/tests/test-repo-assist-validation-gate.sh"
  "bash scripts/tests/test-resolve-dependency-cycles.sh"
